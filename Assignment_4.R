...
plot(training_roc_curve, main = "ROC Curve for Training Data")
...
validation_risk <- validation_risk %>%
  mutate(risk_group = ifelse(validation_risk$probability > median(training_risk$probability), "high_risk", "low_risk"))
...
plot(validation_roc_curve, main = "ROC Curve for Validation Data")
